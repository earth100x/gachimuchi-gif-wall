...
- [Gachimuchi GIF Wall Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    - [GIF](./data-models.md#gif)
    - [Tenor API Response](./data-models.md#tenor-api-response)
  - [API Specification](./api-specification.md)
    - [REST API Specification](./api-specification.md#rest-api-specification)
  - [Components](./components.md)
    - [GIF Grid Component](./components.md#gif-grid-component)
    - [Infinite Scroll Hook](./components.md#infinite-scroll-hook)
    - [Tenor API Client](./components.md#tenor-api-client)
    - [Full-Size Modal Component](./components.md#full-size-modal-component)
  - [External APIs](./external-apis.md)
    - [Tenor API](./external-apis.md#tenor-api)
  - [Core Workflows](./core-workflows.md)
    - [GIF Loading Workflow](./core-workflows.md#gif-loading-workflow)
